...
import ch.telegraphstudios.TSMenuBar.FileDrop.TransferableObject;
...
public class FileDrop {
			...
			dropListener = new java.awt.dnd.DropTargetListener() {
				public void dragEnter(java.awt.dnd.DropTargetDragEvent evt) {
					...
					if (isDragOk(out, evt)) {
						 ...
						 * c; normalBorder = jc.getBorder(); log( out,
						 * "FileDrop: normal border saved." ); jc.setBorder(
						 * dragBorder ); log( out, "FileDrop: drag border set."
						 * ); }
						 */ // end if: JComponent
						...
						listener.fileDragEnter(files, c);
				...
				public void drop(java.awt.dnd.DropTargetDropEvent evt) {
					...
					try { // Get whatever was dropped
						...
						else // this section will check for a reader flavor.
						{
							...
							for (int zz = 0; zz < flavors.length; zz++) {
								if (flavors[zz].isRepresentationClassReader()) {
									...
									if (listener != null)
										listener.filesDropped(createFileArray(br, out), c);
						 ...
						 * if( c instanceof javax.swing.JComponent ) {
						 * javax.swing.JComponent jc = (javax.swing.JComponent)
						 * c; jc.setBorder( normalBorder ); log( out,
				...
				public void dragExit(java.awt.dnd.DropTargetEvent evt) {
					 ...
					 * jc.setBorder( normalBorder ); log( out,
					 * "FileDrop: normal border restored." ); }
					 */ // end if: JComponent

					listener.fileDragExit(c);
				} // end dragExit
	...
	public static interface Listener {
		 ...
		 * @since 1.0
		 */
		public abstract void filesDropped(java.io.File[] files, Component c);

		public abstract void fileDragEnter(java.io.File[] files, Component c);

		public abstract void fileDragExit(Component c);
